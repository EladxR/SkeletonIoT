...
namespace SimulatedDevice
{
    class Program
    {
        ...
        private const string DeviceConnectionString = @"HostName=SkeletonHub.azure-devices.net;DeviceId=ourdevice;SharedAccessKey=i8qhh8TWILiUJ5abCP7FqwOK0+RBgQEPcHGo6QnRgRc=";
